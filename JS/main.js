...
// document.querySelectorAll(".side-bar__elem").forEach((item) => {
//   item.addEventListener("click", function (event) {
//     switch (event.currentTarget.id) {
//       case "falafel_btn":
//         document
//           .getElementById("falafel_ctg")
//           .scrollIntoView({ behavior: "smooth", block: "start" });
//         break;
//       case "shawarma_btn":
//         document
//           .getElementById("shawarma_ctg")
//           .scrollIntoView({ behavior: "smooth", block: "start" });
//         break;
//       case "broasted_btn":
//         document
//           .getElementById("broasted_ctg")
//           .scrollIntoView({ behavior: "smooth", block: "start" });
//         break;
//       case "burger_btn":
//         document
//           .getElementById("burger_ctg")
//           .scrollIntoView({ behavior: "smooth", block: "start" });
//         break;
//       case "apptizers_btn":
//         document
//           .getElementById("apptizers_ctg")
//           .scrollIntoView({ behavior: "smooth", block: "start" });
//         break;
//       case "barbecue_btn":
//         document
//           .getElementById("barbeque_ctg")
//           .scrollIntoView({ behavior: "smooth", block: "start" });
//         break;
//     }
//   });
...
// // //---------------------------- THE MENU --------------------------//
// // // let categories =[{"name":"arabic","id":"1"}];
// // let meals = [
// //   [
// //     {
