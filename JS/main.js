!(function (e) {
  function t(e, t) {
    ...
    for (
      ...
      n.test(r[s].className) && a.push(r[s]);
    return a;
  }
  function a(e, t) {
  ...
  function o(o) {
    ...
    s(o, "mousedown touchstart", function (e) {
      if (
        ...
        (g = (e.touches ? e.touches[0] : e).pageX),
          (d = 0),
          e.preventDefault(),
          e.stopPropagation(),
          (v = o.clientWidth);
      ...
      s(o, "mousemove touchmove", function (e) {
        if (g) {
          ...
          e.preventDefault(),
            e.stopPropagation(),
            (d = t - g >= v ? v + g : -v >= t - g ? -v + g : t),
            a(l, "cs_show"),
            r(c, {
              WebkitTransform:
                "translate3d(" + (-v * h + d - g) + "px,0px,0px)",
  ...
  (!e.all || window.atob) &&
    s(window, "load", function () {
      for (var a = t(e.body, "csslider"), n = 0, r = a.length; r > n; n++)
        new o(a[n]);
    });
})(document);
